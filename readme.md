...
# These are just my person custom presets for different themes.  
So I started to Deprecate Aroma-White due to instability issues and lag  
These are custom presets that I made from themes (which are linked)  
Do note that I don't really claim anything on these  
Also use with Vizality (or similiar mods)  
# Original Themes  
